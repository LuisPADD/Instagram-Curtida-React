...
<p>
⬛ Projeto desenvolvido durante aulas de React, criando a tela inicial e um botão de curtida funcional no estilo Instagram.
</p>

---

## 📜 Descrição
- 📷 **Tela inicial** simulando um feed do Instagram  
- ❤️ **Botão de curtida** que alterna entre curtido/não curtido  
- 🔄 Atualização dinâmica da contagem de curtidas  
